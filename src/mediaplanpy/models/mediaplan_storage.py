...
This module provides a StorageMixin class with standardized methods for saving,
loading, and deleting media plans from various storage backends.
"""
...
class StorageMixin:
    """
    Mixin class providing storage functionality for MediaPlan.

    This mixin adds methods for saving, loading, and deleting media plans
    from various storage backends with comprehensive version validation.
    """
    ...
    def get_version_info(self) -> Dict[str, Any]:
        ...
        version_info = {
            ...
            "created_by": self.meta.created_by_name
        }
